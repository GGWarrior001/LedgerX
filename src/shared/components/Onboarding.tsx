...
export default function Onboarding() {
  ...
  return (
    <div className="onboarding-overlay">
      <div className="bg-card rounded-2xl w-[520px] max-w-[95vw] overflow-hidden shadow-2xl" style={{ animation: 'fadeIn 300ms ease' }}>
        {/* Hero */}
        <div className="px-8 pt-[30px] pb-6" style={{ background: 'linear-gradient(135deg, hsl(239 84% 67%), hsl(243 75% 59%))' }}>
          <div className="w-11 h-11 rounded-xl flex items-center justify-center font-extrabold text-base mb-4" style={{ background: 'rgba(255,255,255,0.15)', color: '#fff' }}>LX</div>
          <h1 className="text-[22px] font-bold tracking-tight mb-1.5" style={{ color: '#fff' }}>Welcome to LedgerX</h1>
          <p className="text-[13.5px]" style={{ color: 'rgba(255,255,255,0.8)' }}>Your modern accounting workspace — let's set it up in 2 quick steps.</p>
        </div>
          ...
          {step === 1 && (
            <div>
              ...
              <div className="flex justify-between items-center mt-5">
                ...
                <button onClick={onNext} className="inline-flex items-center gap-1 px-3.5 py-2 rounded-lg text-[12.5px] font-medium bg-primary text-primary-foreground cursor-pointer hover:opacity-90 transition-opacity">Continue →</button>
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                ...
                >
                  ...
                  <div className="text-[11.5px] text-muted-foreground">Upload a previously exported JSON file to restore your data.</div>
                </div>
                <div
                  className="border-2 border-border rounded-xl p-3.5 cursor-pointer transition-all hover:border-primary hover:bg-primary/5"
                ...
                >
                  ...
                  <div className="text-[11.5px] text-muted-foreground">Begin with an empty workspace and add your own real data.</div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mt-5">
                <button onClick={() => setStep(1)} className="inline-flex items-center gap-1 px-3.5 py-2 rounded-lg text-[12.5px] font-medium bg-background border border-border cursor-pointer hover:bg-muted transition-colors">← Back</button>
                <button onClick={() => finish('fresh')} className="inline-flex items-center gap-1 px-3.5 py-2 rounded-lg text-[12.5px] font-medium bg-primary text-primary-foreground cursor-pointer hover:opacity-90 transition-opacity">Get Started 🚀</button>
              </div>
            </div>
          )}
        </div>
