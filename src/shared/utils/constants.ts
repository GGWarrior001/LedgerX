import type { Invoice, Expense, Client, Vendor } from '@/shared/types';

export const COLORS = ['#6366F1', '#EC4899', '#10B981', '#F97316', '#8B5CF6', '#14B8A6', '#F59E0B', '#3B82F6', '#EF4444', '#0EA5E9'];

export const CLIENT_COLORS = ['#6366F1', '#EC4899', '#10B981', '#F97316', '#8B5CF6', '#14B8A6', '#F59E0B', '#3B82F6'];

export const VENDOR_COLORS = ['#F59E0B', '#10B981', '#8B5CF6', '#3B82F6', '#EC4899', '#6366F1'];
